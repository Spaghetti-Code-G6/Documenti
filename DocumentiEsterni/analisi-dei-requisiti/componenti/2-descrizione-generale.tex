...
\begin{itemize}
    ...
    \item Il back end dell'applicazione dovrà essere sviluppato in \glossario{Java} con server \glossario{Tomcat}, 
    ...
    esterno, inoltre essi dovranno avere almeno fino a 15 dimensioni;
