...
Il progetto \emph{HD Viz} ha come scopo la realizzazione di una \glossario{applicazione web}, nella quale verranno visualizzati dati con molte dimensioni in grafici specifici, a supporto della fase esplorativa dell'analisi dei dati.
...
Il \glossario{back-end} verrà sviluppato in JavaScript con server \glossario{Node.js}. L'applicazione ricaverà dati immagazinati in un database \glossario{NoSQL} all'interno del server Node.js.
...
\begin{itemize}
    \item Il proponente consiglia di utlizzare JavaScript, e più in particolare la libreria \glossario{D3.js}, per lo sviluppo dei grafici usati per la visulizzazione dei dati: \\ \url{https://github.com/d3/d3};
    ...
    \begin{itemize}
        ...
        \item L'\glossario{Heat Map} trasforma la distanza tra i punti in colori più o meno accesi. In questo grafico dovrà essere svolto l'ordinamento dei dati in modo che le strutture presenti siano più visibili all'utente; inoltre è possibile assocciare un \glossario{dendrogramma} lungo i bordi del grafico. \\ \url{https://observablehq.com/@eliaslevy/d3-heatmap}; 
