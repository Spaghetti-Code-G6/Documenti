...
\begin{longtable}[H]{>{\raggedright\bfseries}m{20mm} >{\raggedright}m{90mm} >{\raggedright}m{28mm} >{\raggedright\arraybackslash}m{30mm}}
    ...
    & Obbligatorio
    & \makecell{ Interno \\ \hyperref[ssub:uc2]{UC2}}\\
    ...
    & Desiderabile
    & \makecell{ Interno \\  \hyperref[par:uc4.6]{UC4.6} }\\
