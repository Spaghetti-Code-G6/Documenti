...
\begin{itemize}
    ...
    \item \textbf{Generalizzazioni}:
        \begin{itemize}
            ...
            \item Modifica Force Field (UC4.3 \refSec{ssub:uc4.3})
            \item Modifica Heat Map (UC4.4 \refSec{ssub:uc4.4})
            \item Modifica Proiezione Lineare Multiasse (UC4.5 \refSec{ssub:uc4.5})
        \end{itemize}
