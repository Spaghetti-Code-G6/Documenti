...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
        \begin{enumerate}
            \item L'utente seleziona uno degli algoritmi di calcolo della distanza tra "\glossario{Euclidea}", "\glossario{Manhattan}", "\glossario{Minkowski}", "\glossario{Canberra}".
...
\label{par:uc4.5.1}
\begin{itemize}
    \item \textbf{Descrizione}: L'utente decide di modificare la scala di colori applicata alla Distance Map scegliendo una tra "\glossario{Blue-Magenta-Yellow}", "\glossario{CoolWarm}", "\glossario{Dim Gray}";
    \item \textbf{Attore primario}: Utente;
...
\label{par:uc4.7.1}
\begin{itemize}
    \item \textbf{Descrizione}: L'utente decide di modificare la scala di colori applicata alla Heat Map scegliendo una tra "\glossario{Blue-Magenta-Yellow}", "\glossario{CoolWarm}", "\glossario{Dim Gray}";
...
\subparagraph{UC4.7.2 - Modifica etichette}
\label{spar:uc4.7.2}
\begin{itemize}
...
\subparagraph{UC4.7.3 - Modifica etichette delle righe}
\label{spar:uc4.7.3}
\begin{itemize}
...
\subparagraph{UC4.7.4 - Modifica etichette delle colonne}
\label{spar:uc4.7.4}
\begin{itemize}
...
\subparagraph{UC4.7.5 - Ordinamento grafico}
\label{spar:uc4.7.5}
\begin{itemize}
...
\subparagraph{UC4.7.4.7 - Ordinamento grafico secondo ordine originario }
