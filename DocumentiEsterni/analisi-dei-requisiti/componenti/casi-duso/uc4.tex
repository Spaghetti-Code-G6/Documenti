...
\subsubsection{UC4.3.1 Modifica della distanza}
\label{ssub:uc4.3.1}
\begin{itemize}
...
\subsubsection{UC4.3.3 Modifica influenza di una dimensione}
\label{ssub:uc4.3.3}
\begin{itemize}
...
\subsubsection{UC4.5.1 Modifica gradiente di colori}
\label{ssub:uc4.5.1}
\begin{itemize}
...
\subsubsection{UC4.5.3 Ordinamento clustering gerarchico}
\label{ssub:uc4.5.3}
\begin{itemize}
...
\subsubsection{UC4.5.5 Ordinamento per dimensione}
\label{ssub:uc4.5.5}
\begin{itemize}
