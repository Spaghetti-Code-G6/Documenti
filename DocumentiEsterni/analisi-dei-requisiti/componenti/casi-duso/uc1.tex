...
\begin{itemize}
    \item \textbf{Descrizione}: L'utente prepara l'applicativo HD Viz alla rappresentazione
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
		\begin{enumerate}
			\item L'utente inserisce nel form una query per il reperimento dei dati che viene eseguita sul server.
