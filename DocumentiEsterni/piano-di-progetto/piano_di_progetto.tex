...
\setDescrizione{Questo documento ha lo scopo di descrivere la pianificazione del gruppo SpaghettiCode nello sviluppo del progetto HD Viz}
...
\label{sec:rischi}
\subfile{componenti/analisi_rischi.tex}

\newpage
\section{Modello di sviluppo}
\label{sec:sviluppo}
\subfile{componenti/modello_di_sviluppo.tex}

\newpage
\section{Pianificazione}
\label{sec:pianif}
\subfile{componenti/pianificazione.tex}

\newpage
\section{Preventivo}
\label{sec:prev}
\subfile{componenti/preventivo.tex}

\newpage
\section{Consultivo}
\label{sec:cons}
\subfile{componenti/consultivo.tex}

\newpage
\section{Organigramma}
\label{sec:org}
\subfile{componenti/organigramma.tex}
