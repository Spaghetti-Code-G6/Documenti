...
\setModifiche{
  v1.0.0 & Giorgia Paparazzo & Responsabile & 2021-01-07 & Approvazione documento \\
  v0.2.0 & Samuel Kostadinov & Verificatore & 2021-01-07 & Veririfica \S\ref{sec:introduzione}, \S\ref{sec:rischi}, \S\ref{sec:sviluppo} \\
  v0.1.0 & Manuel Pagotto & Verificatore & 2021-01-06 & Veririfica \S\ref{sec:pianif}, \S\ref{sec:prev}, \S\ref{sec:cons}, \S\ref{sec:org} \\
  v0.0.6 & Giorgia Paparazzo & Responsabile & 2021-01-05 & Modifica \S\ref{sec:pianif}, \S\ref{sec:org} \\
  v0.0.5 & Giorgia Paparazzo & Responsabile & 2021-01-04 & Modifica \S\ref{sec:rischi}, \S\ref{sec:prev}, \S\ref{sec:cons} \\ 
  v0.0.4 & Giorgia Paparazzo & Responsabile & 2020-12-27 & Modifica  \S\ref{sec:org}, \S\ref{sec:cons}, \S\ref{sec:prev} \\
  v0.0.3 & Giorgia Paparazzo & Responsabile & 2020-12-21 & Inizio \S\ref{sec:prev}, proseguimento \S\ref{sec:pianif}  \\
  v0.0.2 & Giorgia Paparazzo & Responsabile & 2020-12-18 & Stesura \S\ref{sec:introduzione}, \S\ref{sec:rischi} ,\S\ref{sec:sviluppo}, \S\ref{sec:pianif}  \\
  v0.0.1 & Giorgia Paparazzo & Responsabile & 2020-12-17 & Inizio stesura \S\ref{sec:org}
}
