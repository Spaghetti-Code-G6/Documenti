...
Tutti i ruoli sono e saranno sempre assunti su base volontaria. Essendo la prima volta per ciascun membro, sono emerse alcune difficoltà che tuttavia sono state superate.\\
...
\begin{longtable}{|p{3cm}|p{4.5cm}|p{4.5cm}|}
		...
		\rowcolor{lightgray}
            ...
            Si è scelto di affidare il ruolo di Verificatore a più componenti del gruppo in quanto ciascuno riesce a notare
            aspetti che qualcun altro non percepisce \\
            \hline
