...
\setModifiche{
  v0.0.4 & Giorgia Paparazzo & Redattore & 2020-12-31 & Inserito capitolo \S6 \\
...
\label{sec:lista}
%\subfile{componenti/5-lista_controllo.tex}

\newpage
\section{Valutazioni per il miglioramento}
\label{sec:valutazioni}
\subfile{componenti/6-valutazioni_miglioramento.tex}
