...
\setModifiche{
  ...
  v0.0.1 & Giorgia Paparazzo & Redattore & 2020-12-23 & Inizio stesura capitolo 
}
...
\label{sec:qproc}
%\subfile{componenti/qualita_processo.tex}

\newpage
\section{Qualità del prodotto}
\label{sec:qprod}
%\subfile{componenti/qualita_prodotto.tex}

\newpage
\section{Specifica dei test}
\label{sec:spectest}
%\subfile{componenti/specifica_test.tex}
