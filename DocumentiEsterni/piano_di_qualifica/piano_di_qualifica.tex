...
\setModifiche{
  v0.0.5 & Giorgia Paparazzo & Redattore & 2021-01-01 & Stesura capitolo \S6 \\
  v0.0.4 & Giorgia Paparazzo & Redattore & 2020-12-31 & Stesura capitolo \S7, inizio capitolo \S5 \\
...
\label{sec:resoconto}
\subfile{componenti/5-resoconto_attivita.tex}

\newpage
\section{Lista di Controllo}
\label{sec:lista}
\subfile{componenti/6-lista_controllo.tex}

\newpage
\section{Valutazioni per il miglioramento}
\label{sec:valutazioni}
\subfile{componenti/7-valutazioni_miglioramento.tex}
