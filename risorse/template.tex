...
\begin{titlepage}% per non stampare il numero della pagina
  ...
  \parbox[b]{0.5\textwidth}{% cambiando la larghezza del testo il paragrafo si muove a destra o a sinistra 
  {\hspace{0.07\textwidth}\includegraphics[width=4cm,height=4cm]{logo-nero.png}}\\[3\baselineskip] % logo
