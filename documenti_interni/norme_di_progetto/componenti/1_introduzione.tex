...
specifiche di ciascun processo del \glossario{progetto}.
% continuamente a modifiche, rimozioni o 
% aggiunte; al completamento di una qualsiasi di queste azioni, tutti i membri del gruppo dovranno essere notificati. Il 
% documento è, infatti, ancora incompleto e verrà aggiornato riguardo alle regole specifiche per ogni processo del 
% \glossario{progetto}.
