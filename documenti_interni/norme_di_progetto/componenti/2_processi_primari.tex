...
\end{itemize}
% TODO: fasi usato impropriamente
...
\glossario{issue} stesse, diviso tra "To do", "In progress" e "Done", allo stesso tempo tiene sempre aggiornati i 
...
\refSec{par:stile_codifica}, per far si che il codice sia più leggibile possibile.
