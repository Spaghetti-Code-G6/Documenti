...
\subsection{Processi di coordinamento}
    ...
    \begin{itemize}
        \item Proponente: \emph{Gregorio Piccoli} rappresentante dell'azienda \empg{Zucchetti S.p.A.};
        \item Commitente: prof. \emph{Vardanega Tullio} e prof. \emph{Cardin Riccardo};
