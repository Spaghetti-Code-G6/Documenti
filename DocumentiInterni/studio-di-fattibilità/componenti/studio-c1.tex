...
\begin{itemize}
  \item \textbf{Java}: linguaggio di programmazione ad alto livello, orientato agli oggetti e a tipizzazione statica, progettato per rendere il più indipendente possibile il software dalla piattaforma hardware.
...
\begin{itemize}
  \item \glossario{\textbf{API REST}}: particolare architettura di sistemi distribuiti che non prevede il concetto di sessione, bensì si basa sulla trasmissione di dati mediante il protocollo HTTP senza ulteriori livelli;
...
\begin{itemize}
  \item \textbf{Kubernetes}: sistema open source di orchestrazione e gestione di container;
  \item \textbf{Openshift}: piattaforma per applicazioni cloud che permette di facilitarne lo sviluppo, la distribuzione e la scalabilità;
