...
\setDescrizione{Riassunto dell'incontro realizzato dal gruppo SpaghettiCode tenutosi il 21 Dicembre 2020 in forma di meeting online.}
...
\label{sec:resoconto}
	...
	all'utilizzo della repository su \glossario{Github} e dell'utilizzo di \LaTeX\ per la redazione dei documenti. In un primo momento a questi strumenti era stato preferito 
	...
	\glossario{Spaghetti Code} su Github.
